          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/80">コーヒーと癒しの空間</p>
              </div>
            </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-white/80">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 text-accent-light" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <span>東京都渋谷区猫町1-2-3 ネコビル 1F</span>
              </li>
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-accent-light" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <li className="flex items-center">
                ...
                <span>info@kotarou-cafe.com</span>
              </li>
            </ul>
          </div>
        </div>
